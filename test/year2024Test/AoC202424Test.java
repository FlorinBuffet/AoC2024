...
class AoC202424Test {
    ...
    private static final long PERSONAL_RESULT_PART1 = 56278503604006L;
    private static final long PERSONAL_RESULT_PART2 = 82570698600470L;
    ...
    void partOneSamples(String sample, long expectedResult) throws Exception {
    ...
    @MethodSource("inputAndResultsSamples")
    void partTwoSamples(String sample, int irrelevant, long expectedResult) throws Exception {
     ...
     * -1 is used to indicate that the test is not relevant for the part.
     *
