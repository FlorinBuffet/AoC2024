...
class AoC202419Test {
    ...
    private static final int PERSONAL_RESULT_PART1 = 317;
    private static final long PERSONAL_RESULT_PART2 = 883443544805484L;
    ...
    private static Stream<Arguments> inputAndResultsSamples() {
        return Stream.of(Arguments.of("a", 6, 16));
    }
}