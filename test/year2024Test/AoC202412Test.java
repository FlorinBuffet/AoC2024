...
class AoC202412Test {
    ...
    private static final int PERSONAL_RESULT_PART1 = 1467094;
    ...
    private static Stream<Arguments> inputAndResultsSamples() {
        return Stream.of(
                Arguments.of("a", 140, 80),
                Arguments.of("b", 772, 436),
                Arguments.of("c", 1930, 1206),
                Arguments.of("d", -1, 236),
                Arguments.of("e", -1, 368)
        );
    }
}