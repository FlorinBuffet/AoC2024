...
class AoC202411Test {
    ...
    private static final int PERSONAL_RESULT_PART1 = 194557;
    private static final long PERSONAL_RESULT_PART2 = 231532558973909L;
    ...
    @MethodSource("inputAndResultsSamples")
    void partTwoSampleA(String sample, int irrelevant, long expectedResult) throws Exception {
     ...
     * Sample a Part 2 is my own-expected value.
     *
    ...
    private static Stream<Arguments> inputAndResultsSamples() {
        return Stream.of(Arguments.of("a", 55312, 65601038650482L));
    }
}